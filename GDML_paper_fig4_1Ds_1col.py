...
#    xaxis_label_down =  r"$s/L_\mathrm{c}$"
    ...
    if plot_down == 1:
        ...
        xlim = 31
        axes1[0].set_ylabel(r"$j_\mathrm{niP}$ (Acm$^{-2}$)",fontsize = font_size)
        ...
        axes1[2].set_ylabel(r"$\phi_\mathrm{P}$ (V)",fontsize = font_size)
        # axes1[2].set_xlabel(prof_xlabel,fontsize = font_size)
        axes1[2].set_xlim(0,xlim)
        axes1[2].set_xticks(np.arange(0,30+5,5))
        axes1[2].set_ylim(0,12)
        # axes1[2].set_yticks([2,4,6,8,10,12,14])
        text = '(c)'
        # zstext = 1.1*3
        # rstext = 0.9*14
        ...
        axes1[3].set_ylabel(r"$T_\mathrm{eP}$ (eV)",fontsize = font_size)
        # axes1[3].set_xlabel(prof_xlabel,fontsize = font_size)
        axes1[3].set_xlim(0,xlim)
        axes1[3].set_xticks(np.arange(0,30+5,5))
        axes1[3].set_ylim(0,5)
        text = '(d)'
        # zstext = 1.1*3
        # rstext = 0.9*14
        axes1[3].text(zstext,rstext,text,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[3].transAxes)  
        axes1[3].tick_params(labelsize = ticks_size,labelbottom=False)
        
        
        axes1[4].set_ylabel(r"$P''_\mathrm{niP}$ (Wcm$^{-2}$)",fontsize = font_size)
        # axes1[4].set_xlabel(prof_xlabel,fontsize = font_size)
        axes1[4].set_xlim(0,xlim)
        axes1[4].set_xticks(np.arange(0,30+5,5))
        axes1[4].set_ylim(1E-4,1E2)
        # axes1[4].set_yticks([1E16,5E16,1E17,3E17])
        text = '(e)'
        # zstext = 1.1*3
        # rstext = 0.9*3E17
        axes1[4].text(zstext,rstext,text,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[4].transAxes)  
        axes1[4].tick_params(labelsize = ticks_size,labelbottom=False)
        

        axes1[5].set_ylabel(r"$P''_\mathrm{neP}$ (Wcm$^{-2}$)",fontsize = font_size)
        axes1[5].set_xlabel(prof_xlabel,fontsize = font_size)
        axes1[5].set_xlim(0,xlim)
        axes1[5].set_xticks(np.arange(0,30+5,5))
        axes1[5].set_ylim(1E-4,1E2)
        # axes1[5].set_yticks([1E16,5E16,1E17,3E17])
        text = '(f)'
        # zstext = 1.1*3
        # rstext = 0.9*3E17
        axes1[5].text(zstext,rstext,text,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[5].transAxes)  
        axes1[5].tick_params(labelsize = ticks_size)
...
#                ji_tot_b_plot[bIDfaces_wall][i]  = 0.0
        ...
        if plot_down == 1:
            ...
            if plot_type == 0 or plot_type == 2:
                axes1[0].semilogy(sdown,ji_tot_b_plot[bIDfaces_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])                
                axes1[1].semilogy(sdown,-je_b_plot[bIDfaces_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])                
                axes1[2].plot(sdown,phi_plot[IDfaces_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[3].plot(sdown,Te_plot[IDfaces_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[4].semilogy(sdown_surf,qi_tot_wall_surf_plot[indsurf_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[5].semilogy(sdown,qe_tot_b_plot[bIDfaces_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
            if plot_type == 1 and picvars_plot == 1:
                axes1[0].semilogy(sdown_nodes,ji_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[1].semilogy(sdown_nodes,-je_b_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[2].plot(sdown_nodes,phi_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[3].plot(sdown_nodes,Te_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[4].semilogy(sdown_nodes,qi_tot_wall_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[5].semilogy(sdown_nodes,qe_tot_b_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
    ...
    fig1.tight_layout()
    if save_flag == 1:
        fig1.savefig(path_out+"fig4_1Ds_1col"+figs_format,bbox_inches='tight')
        plt.close(fig1)
