...
path_out = "VHT_MP_US_plume_sims/paper_GDML_figs/fig5_paper/new_sims/revision1/"
...
#    zcat_pos       = 5.688635            # z coordinate of crossing point of cathode topo1 251 Bline with rind = 17 
    ...
    zcat_pos2 = np.mean([16.0103,16.0385,16.03545]) # paper GDML: Plot NEW cross with MS (magnetic separatrix) instead of cross with cathode line
                                                    # New (more precise) cross with MS is considered at the average z value of the cross with MS across plume sizes 
...
#    rprof_xlabel = r"$r$ (cm)"
    ...
    [fig1, axes1] = plt.subplots(nrows=2, ncols=2, figsize=(15,6))
    ...
    axes1[1,0].tick_params(labelsize = ticks_size)
    ...
    axes1[1,1].tick_params(labelsize = ticks_size)
...
#        nu_i12_plot       = nu_i12_plot*1E-6
    ...
    fig1.tight_layout()
    if save_flag == 1:
        fig1.savefig(path_out+"fig5_rev1"+figs_format,bbox_inches='tight')
        fig1.savefig(path_out+"fig5_rev1"+figs_format2,bbox_inches='tight')
        plt.close(fig1)
