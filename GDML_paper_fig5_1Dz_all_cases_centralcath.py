...
#    last_steps      = 40
    ...
    oldpost_sim      = np.array([6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6],dtype = int)
    oldsimparams_sim = np.array([20,20,20,20,20,20,20,20,20,20,20,20,20,20,20,20,20,20,20,20,20],dtype = int)  
...
#    colors = ['r','k','g','b','m','c','m','y',orange,brown]
    ...
    colors = ['m','k','b','r',grey,'c',orange,'g','y','m','k','b','r',grey,'c',orange,'g','y'] # P1G-P4G, P1L-P4L (paper)
...
#    rprof_xlabel = r"$r$ (cm)"
    ...
    for k in range(0,nsims):
        ...
        [num_ion_spe,num_neu_spe,Z_ion_spe,n_mp_cell_i,n_mp_cell_n,n_mp_cell_i_min,
           ...
           Boltz,Boltz_dim,Pfield_e,Ebal_e,ge_b,ge_b_acc,ge_sb_b,ge_sb_b_acc,
...
#        nu_i12_plot       = nu_i12_plot*1E-6
        ...
        if k <= 8:
            if interp_MFAM_picM_plot == 1:
                ...
                axes1[0,0].plot(z_prof_mp,phi_prof_mp, linestyle=linestyles[k], linewidth = line_width, markevery=marker_every_mesh, markersize=marker_size_vec[ind], marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[1,0].plot(z_prof_mp,Te_prof_mp, linestyle=linestyles[k], linewidth = line_width, markevery=marker_every_mesh, markersize=marker_size_vec[ind], marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
            else:
            ...
            axes1[2,0].plot(z_prof,ne_prof, linestyle=linestyles[k], linewidth = line_width, markevery=marker_every, markersize=marker_size_vec[ind], marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
            ...
            if interp_MFAM_picM_plot == 1:
                ...
                axes1[0,1].plot(z_prof_mp,phi_prof_mp, linestyle=linestyles[k], linewidth = line_width, markevery=marker_every_mesh, markersize=marker_size_vec[ind], marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[1,1].plot(z_prof_mp,Te_prof_mp, linestyle=linestyles[k], linewidth = line_width, markevery=marker_every_mesh, markersize=marker_size_vec[ind], marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
            ...
            axes1[2,1].plot(z_prof,ne_prof, linestyle=linestyles[k], linewidth = line_width, markevery=marker_every, markersize=marker_size_vec[ind], marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
    ...
    legend2 = axes1[0,0].legend([lines1[i] for i in [4,5,6,7,8]], [lines1[i].get_label() for i in [4,5,6,7,8]], bbox_to_anchor=(0.79, 1.0),loc='upper left',fontsize = font_size_legend,ncol=1,frameon = True) 
    ...
    legend4 = axes1[0,1].legend([lines2[i] for i in [4,5,6,7,8]], [lines2[i].get_label() for i in [4,5,6,7,8]], bbox_to_anchor=(0.77, 1.0),loc='upper left',fontsize = font_size_legend,ncol=1,frameon = True) 
    ...
    fig1.tight_layout()
    if save_flag == 1:
        fig1.savefig(path_out+"fig5_1Dz_P3G_Tcath"+figs_format,bbox_inches='tight')
        plt.close(fig1)
