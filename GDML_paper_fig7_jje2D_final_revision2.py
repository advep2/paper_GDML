...
from GDML_paper_contour_2D_fig7 import contour_2D_fig7
...
path_out = "VHT_MP_US_plume_sims/paper_GDML_figs/fig7_paper/revision2/"
...
#    cont_ylabel = '$r$ (cm)'
    ...
    if plot_curr_ref == 1:
        ...
        [fig1, axes1] = plt.subplots(nrows=2, ncols=2, figsize=(15.0,12))
    ...
    #    yticks_lim = rs[-1,-1]+1
        ...
        if ind1 == 0:
            if ind2 == 0:
                ...
                text_title = r"(c) LP3C3 "
        elif ind1 == 1:
            if ind2 == 0:
                text_title = r"(b) GP3C3 " 
            elif ind2 == 1:
                text_title = r"(d) GP3C3 "
    ...
    #        lines_ticks_loc  = [(1.5,4.25),(3.4,4.25),(4.8,1.43),(7.56,7.4),(9.34,5.16),(8.45,0.6),(5.9,5.5),(4.0,6.4)]        
            ...
            if interp_MFAM_picM_plot == 1:
                ...
                [CS,CS2] = contour_2D_fig7 (axes1[ind1,ind2],cont_xlabel, cont_ylabel, font_size, ticks_size, zs_mp, rs_mp, var, nodes_flag_mp, log_type, auto, 
                ...
                [CS,CS2] = contour_2D_fig7 (axes1[ind1,ind2],cont_xlabel, cont_ylabel, font_size, ticks_size, zs, rs, var, nodes_flag, log_type, auto, 
                                       min_val0, max_val0, cont, lines, cont_nlevels, auto_cbar_ticks, auto_lines_ticks,
                                       nticks_cbar, nticks_lines, cbar_ticks, lines_ticks, lines_ticks_loc, cbar_ticks_fmt,
                                       lines_ticks_fmt, lines_ticks_color, lines_style, lines_width) 
    ...
    #            ax.set_yticks(np.arange(0,rs[-1,-1],2))
            ...
            if plot_cath_contours == 1:
                axes1[ind1,ind2].plot(1.05*z_cath,r_cath+0.1,linewidth = line_width_boundary,markersize = marker_size,marker = 's',color = cath_marker_color,markeredgecolor = cath_marker_edge_color)
                # axes1[ind1,ind2].plot(z_cath,r_cath,'ks',linewidth = line_width_boundary,markersize = marker_size)
    ...
    fig1.tight_layout()
    if save_flag == 1:
        fig1.savefig(path_out+"fig7_rev2"+figs_format,bbox_inches='tight')
        fig1.savefig(path_out+"fig7_rev2"+figs_format2,bbox_inches='tight')
        plt.close(fig1)
