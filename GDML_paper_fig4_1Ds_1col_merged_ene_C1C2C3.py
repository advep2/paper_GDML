...
#                ji_tot_b_plot[bIDfaces_wall][i]  = 0.0
        ...
        if plot_down == 1:
            ...
            if plot_type == 0 or plot_type == 2:
                if k == 0:
                    axes1[0].semilogy(sdown,-je_b_plot[bIDfaces_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec_j[k], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels1[k])                
                    ...
                    axes1[0].semilogy(sdown,-je_b_plot[bIDfaces_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec_j[k+1], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels1[k+1])   
                    axes1[0].semilogy(sdown,ji_tot_b_plot[bIDfaces_down], linestyle='--', linewidth = line_width, markevery=marker_every_vec_j[k+2], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels1[k+2])                
                elif k == 2:
                    axes1[0].semilogy(sdown,-je_b_plot[bIDfaces_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec_j[k+2], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels1[k+2])
                    ...
                    axes1[0].semilogy(sdown,-je_b_plot[bIDfaces_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec_j[k+1+2], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels1[k+1+2])
                    axes1[0].semilogy(sdown,ji_tot_b_plot[bIDfaces_down], linestyle='--', linewidth = line_width, markevery=marker_every_vec_j[k+2+2], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels1[k+2+2])                
                elif k == 4:
                    axes1[0].semilogy(sdown,-je_b_plot[bIDfaces_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec_j[k+2+2], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels1[k+2+2])
                    ...
                    axes1[0].semilogy(sdown,-je_b_plot[bIDfaces_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec_j[k+1+2+2], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels1[k+1+2+2])
                    axes1[0].semilogy(sdown,ji_tot_b_plot[bIDfaces_down], linestyle='--', linewidth = line_width, markevery=marker_every_vec_j[k+2+2+2], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels1[k+2+2+2])                
                ...
                # Figure of energy in linear y scale
                if k == 0:
                    axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels3[k])
                    axes1[3].plot(sdown_surf,avg_imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle='--', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels3[k+1])
                    ...
                    axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels3[k+1])
                    axes1[3].plot(sdown_surf,avg_imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle='--', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels3[k+2])
                    ...
                    axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels3[k+2])
                    axes1[3].plot(sdown_surf,avg_imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle='--', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels3[k+1+2])
                    # axes1[3].plot(sdown_surf,imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle='--', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color='y', markeredgecolor = 'k', label="")
                    # axes1[3].plot(sdown,avg_imp_ene_e_b_plot[bIDfaces_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels3[k+1])
                    # axes1[3].plot(sdown,imp_ene_e_b_plot[bIDfaces_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels3[k+1])
                    # axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle='--', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'c', label=r"$T_\mathrm{eP}\left(2+\frac{\phi_{\infty P}}{T_\mathrm{eP}}\right)$")
                elif k == 3:
                    axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels3[k+1+2])
                    axes1[3].plot(sdown_surf,avg_imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle='--', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels3[k+2+2])
                    # axes1[3].plot(sdown_surf,imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle='--', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color='c', markeredgecolor = 'k', label="")
                    # axes1[3].plot(sdown,avg_imp_ene_e_b_plot[bIDfaces_down], linestyle=linestyles[ind+2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+2], markeredgecolor = 'k', label=labels3[k+2])
                    # axes1[3].plot(sdown,imp_ene_e_b_plot[bIDfaces_down], linestyle=linestyles[ind+2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+2], markeredgecolor = 'k', label=labels3[k+2])
                    # axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle='-.', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=r"4.5$T_\mathrm{eP}$")
                elif k == 4:
                    axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels3[k+2+2])
                    axes1[3].plot(sdown_surf,avg_imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle='--', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels3[k+1+2+2])
                    # axes1[3].plot(sdown_surf,imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle='--', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color='y', markeredgecolor = 'k', label="")
                    # axes1[3].plot(sdown,avg_imp_ene_e_b_plot[bIDfaces_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels3[k+1])
                    # axes1[3].plot(sdown,imp_ene_e_b_plot[bIDfaces_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels3[k+1])
                    # axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle='--', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'c', label=r"$T_\mathrm{eP}\left(2+\frac{\phi_{\infty P}}{T_\mathrm{eP}}\right)$")
                elif k == 5:
                    axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels3[k+1+2+2])
                    axes1[3].plot(sdown_surf,avg_imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle='--', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels3[k+2+2+2])
                    # axes1[3].plot(sdown_surf,imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle='--', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color='c', markeredgecolor = 'k', label="")
                    # axes1[3].plot(sdown,avg_imp_ene_e_b_plot[bIDfaces_down], linestyle=linestyles[ind+2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+2], markeredgecolor = 'k', label=labels3[k+2])
                    # axes1[3].plot(sdown,imp_ene_e_b_plot[bIDfaces_down], linestyle=linestyles[ind+2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+2], markeredgecolor = 'k', label=labels3[k+2])
                    # axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle='-.', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=r"4.5$T_\mathrm{eP}$")
    ...
    if plot_down == 1:
        ...
        axes1[0].legend([lines1_flip1[i] for i in range(0,len(lines1_flip1))], [lines1_flip1[i].get_label() for i in range(0,len(lines1_flip1))],fontsize = font_size_legend,loc='best',ncol=3,frameon = True,numpoints=2,handlelength=2.9,borderpad=0.2,columnspacing=1) 
        axes1[1].legend([lines2_flip2[i] for i in range(0,len(lines2_flip2))], [lines2_flip2[i].get_label() for i in range(0,len(lines2_flip2))],fontsize = font_size_legend,loc='best',ncol=3,frameon = True,numpoints=2,handlelength=2.9,borderpad=0.2,columnspacing=1) 
        axes1[2].legend([lines3_flip3[i] for i in range(0,len(lines3_flip3))], [lines3_flip3[i].get_label() for i in range(0,len(lines3_flip3))],fontsize = font_size_legend,loc='best',ncol=3,frameon = True,numpoints=2,handlelength=2.9,borderpad=0.2,columnspacing=1) 
        axes1[3].legend([lines4_flip4[i] for i in range(0,len(lines4_flip4))], [lines4_flip4[i].get_label() for i in range(0,len(lines4_flip4))],fontsize = font_size_legend,loc='best',ncol=3,frameon = True,numpoints=2,handlelength=2.9,borderpad=0.2,columnspacing=1) 
