...
#    last_steps      = 40
    ...
    oldpost_sim      = np.array([6,6,6,6,6,6,6,6],dtype = int)
    oldsimparams_sim = np.array([20,20,20,20,20,20,20,20],dtype = int)  
...
#    colors = ['r','k','g','b','m','c','m','y',orange,brown]
    ...
    colors = ['m','k','b','r','m','k','b','r'] # P1G-P4G, P1L-P4L (paper)
...
#    rprof_xlabel = r"$r$ (cm)"
    ...
    axes1[0,0].set_ylim(0,40)
    axes1[0,0].set_yticks([0,10,20,30,40])
    ...
    axes1[2,0].set_ylabel(r"$n_\mathrm{e}$ (m$^{-3}$)",fontsize = font_size)
    ...
    axes1[2,1].set_ylabel(r"$n_\mathrm{e}$ (m$^{-3}$)",fontsize = font_size)
...
#        nu_i12_plot       = nu_i12_plot*1E-6
        ...
        if k <= 3:
            if interp_MFAM_picM_plot == 1:
                axes1[0,0].plot(zs_mp[rind_mp,:],phi_mp[rind_mp,:], linestyle=linestyles[k], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[1,0].plot(zs_mp[rind_mp,:],Te_mp[rind_mp,:], linestyle=linestyles[k], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
            else:
                axes1[0,0].plot(zs[rind,:],phi_plot[rind,:], linestyle=linestyles[k], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[1,0].plot(zs[rind,:],Te_plot[rind,:], linestyle=linestyles[k], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
            axes1[2,0].semilogy(zs[rind,:],ne_plot[rind,:], linestyle=linestyles[k], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
        elif k > 3:
            if interp_MFAM_picM_plot == 1:
                axes1[0,1].plot(zs_mp[rind_mp,:],phi_mp[rind_mp,:], linestyle=linestyles[k], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[1,1].plot(zs_mp[rind_mp,:],Te_mp[rind_mp,:], linestyle=linestyles[k], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
            else:
                axes1[0,1].plot(zs[rind,:],phi_plot[rind,:], linestyle=linestyles[k], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[1,1].plot(zs[rind,:],Te_plot[rind,:], linestyle=linestyles[k], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
            axes1[2,1].semilogy(zs[rind,:],ne_plot[rind,:], linestyle=linestyles[k], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
    ...
    if plot_zcath_012 == 2:
        ...
        # axes1[0,0].plot(zcat_pos*np.ones(2),np.array([ylims[0],ylims[1]]), linestyle='-.', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker="", color='k', markeredgecolor = 'k', label="")
    ...
    # axes1[0,0].legend(fontsize = font_size_legend,loc='best',ncol=2,frameon = True) 
    # axes1[0,1].legend(fontsize = font_size_legend,loc='best',ncol=2,frameon = True) 
    ...
    fig1.tight_layout()
    if save_flag == 1:
        fig1.savefig(path_out+"fig5_1Dz_old"+figs_format,bbox_inches='tight')
        plt.close(fig1)
