...
#    last_steps      = 1000
    ...
    oldsimparams_sim = np.array([21,21,21,20,20,20,20,20,20,20,20,20],dtype = int)   
...
#    cont_ylabel = '$r$ (cm)'
    ...
    fig1.tight_layout()
    if save_flag == 1:
        fig1.savefig(path_out+"fig8_ji2D_GP3C1_GP3C2_GP3C3"+figs_format,bbox_inches='tight')
        plt.close(fig1)
