...
path_out = "VHT_MP_US_plume_sims/paper_GDML_figs/fig6_paper/"
...
#    colors = ['r','k','g','b','m','c','m','y',orange,brown]
    ...
    # colors = ['k','b','r','m','k','b','r'] # P1G-P4G, P1L-P4L (paper)
...
#        nu_i12_plot       = nu_i12_plot*1E-6
    ...
    fig1.tight_layout()
    if save_flag == 1:
        fig1.savefig(path_out+"fig6_1Dz_refC_cases_P4"+figs_format,bbox_inches='tight')
        plt.close(fig1)
