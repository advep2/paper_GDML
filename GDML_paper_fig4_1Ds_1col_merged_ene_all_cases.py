...
#                              "SPT100_picM_Reference1500points.hdf5",
    ...
    # Labels  
    labels1 = [ 
               r"\phantom{-} $j_\mathrm{niP}$ P3G1",
               r"$-j_\mathrm{neP}$ P3G1",
               r"$j_\mathrm{niP}$ P3L1",
               r"$-j_\mathrm{neP}$ P3L1",
               
               r"\phantom{-} $j_\mathrm{niP}$ P3G2",
               r"$-j_\mathrm{neP}$ P3G2",
               r"$j_\mathrm{niP}$ P3L2",
               r"$-j_\mathrm{neP}$ P3L2",
               ]                        
    labels2 = [
    ...
    labels3 = [ 
               r"$\mathcal{E}_\mathrm{niP}/10$ P3G1",
               r"$\mathcal{E}_\mathrm{neP}$ P3G1",
               r"$\mathcal{E}_\mathrm{niP}/10$ P3L1",
               r"$\mathcal{E}_\mathrm{neP}$ P3L1",
               
               r"$\mathcal{E}_\mathrm{niP}/10$ P3G2",
               r"$\mathcal{E}_\mathrm{neP}$ P3G2",
               r"$\mathcal{E}_\mathrm{niP}/10$ P3L2",
               r"$\mathcal{E}_\mathrm{neP}$ P3L2",
               ] 
...
#    xaxis_label_down =  r"$s/L_\mathrm{c}$"
    ...
    for k in range(0,nsims):
        ...
        [num_ion_spe,num_neu_spe,points,zs,rs,zscells,rscells,dims,nodes_flag,
           ...
           imp_ene_n_nodes_v2,Bfield_nodes,
           ...
           imp_ene_n_surf_v2,phi_inf] = HET_sims_read_bound(path_simstate_inp,path_simstate_out,path_postdata_out,path_simparams_inp,
        ...
        if mean_vars == 1:        
            ...
            [delta_r_mean,delta_s_mean,delta_s_csl_mean,dphi_sh_b_mean,je_b_mean,
               ...
               imp_ene_n_surf_mean,imp_ene_n_surf_v2_mean] = HET_sims_mean_bound(nsteps,mean_type,last_steps,step_i,step_f,delta_r,
        ...
        if mean_vars == 1 and plot_mean_vars == 1:
            ...
            [delta_r_plot,delta_s_plot,delta_s_csl_plot,dphi_sh_b_plot,je_b_plot,
               ...
               imp_ene_n3_surf_plot,imp_ene_n_surf_plot,imp_ene_n_surf_v2_plot] = HET_sims_cp_vars_bound(delta_r_mean,delta_s_mean,delta_s_csl_mean,dphi_sh_b_mean,je_b_mean,ji_tot_b_mean,
                                                                                                          ...
                                                                                                          imp_ene_i4_surf_mean,imp_ene_ion_surf_mean,imp_ene_ion_surf_v2_mean,
                                                                                                          imp_ene_n1_surf_mean,imp_ene_n2_surf_mean,imp_ene_n3_surf_mean,
                                                                                                          imp_ene_n_surf_mean,imp_ene_n_surf_v2_mean)
            ...
            [delta_r_plot,delta_s_plot,delta_s_csl_plot,dphi_sh_b_plot,je_b_plot,
               ...
               imp_ene_i3_surf_plot,imp_ene_i4_surf_plot,imp_ene_ion_surf_plot,
               imp_ene_ion_surf_v2_plot,imp_ene_n1_surf_plot,imp_ene_n2_surf_plot,
               imp_ene_n3_surf_plot,imp_ene_n_surf_plot,imp_ene_n_surf_v2_plot] = HET_sims_cp_vars_bound(delta_r,delta_s,delta_s_csl,dphi_sh_b,je_b,ji_tot_b,
                                                                                                        ...
                                                                                                        n_inst,ni1_inst,ni2_inst,nn1_inst,
...
#                ji_tot_b_plot[bIDfaces_wall][i]  = 0.0
    ...
    if plot_down == 1:
        ...
        axes1[0].legend(fontsize = font_size_legend,loc='best',ncol=2,frameon = True) 
        ...
        axes1[3].legend(fontsize = font_size_legend,loc='best',ncol=2,frameon = True) 
    ...
    if save_flag == 1:
        ...
        fig1.savefig(path_out+"fig4_1Ds_cath2_test_interp"+figs_format,bbox_inches='tight')
        plt.close(fig1)
