...
#    cont_ylabel = '$r$ (cm)'
    ...
    if plot_curr_ref == 1:
        ...
        [fig1, axes1] = plt.subplots(nrows=2, ncols=2, figsize=(15,12))
    ...
    #        flag_start = 1
            ...
            if interp_MFAM_picM_plot == 1:
                if k<=3:
                    stream = streamline_2D(axes1[ind1,ind2],zvec,rvec,dims_mp,zs_mp,rs_mp,ji_z_mp,ji_x_mp,flag_start,start_points,
                ...
                if k<=3:
                    stream = streamline_2D(axes1[ind1,ind2],zvec,rvec,dims,zs,rs,ji_z_plot,ji_x_plot,flag_start,start_points,
                                           plot_start_points,streamline_density,streamline_width,streamline_color,arrow_size,
                                           arrow_style,min_length)
                else:
                    stream = streamline_2D(axes1[ind1,ind2],zvec,rvec,dims,zs,rs,ji_z_plot,ji_x_plot,flag_start,start_points,
    ...
    fig1.tight_layout()
    if save_flag == 1:
        fig1.savefig(path_out+"ji2D_ref_complete"+figs_format,bbox_inches='tight')
        plt.close(fig1)
