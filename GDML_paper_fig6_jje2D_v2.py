...
#    cont_ylabel = '$r$ (cm)'
    ...
    #            ax.set_yticks(np.arange(0,rs[-1,-1],2))
            ...
            if plot_cath_Bline == 1:
                ...
                if k == 2 or k == 3 or k == 6 or k == 7:
                    ...
                    axes1[ind1,ind2].plot(cath_z_P2,cath_r_P2,color='g',linestyle='-.',linewidth = line_width_boundary,markersize = marker_size)
            # Plot scan points if required
            if plot_scan_points == 1:
    ...
    fig1.tight_layout()
    if save_flag == 1:
        fig1.savefig(path_out+"jje2D_ref_complete_v2"+figs_format,bbox_inches='tight')
        plt.close(fig1)
