...
path_out = "VHT_MP_US_plume_sims/paper_GDML_figs/fig6_paper/new_sims/revision2/"
...
#    cont_ylabel = '$r$ (cm)'
    ...
    #    yticks_lim = rs[-1,-1]+1
        ...
        if ind1 == 0:
            if ind2 == 0:
                text_title = r"(a) LP3C2 "
            elif ind2 == 1:
                text_title = r"(c) LP4C2 "
            elif ind2 == 2:
                # text_title = r"(e) LP3C2 "
                text_title = r"(e) LP4C2 "
            elif ind2 == 3:
                text_title = r"(g) LP4C2 "
        elif ind1 == 1:
            if ind2 == 0:
                text_title = r"(b) GP3C2 " 
            elif ind2 == 1:
                text_title = r"(d) GP4C2 "
            elif ind2 == 2:
                # text_title = r"(f) GP3C2 "
                text_title = r"(f) GP4C2 "
            elif ind2 == 3:
                text_title = r"(h) GP4C2 "
    ...
    fig1.tight_layout()
    if save_flag == 1:
        fig1.savefig(path_out+"fig6_rev2"+figs_format,bbox_inches='tight')
        fig1.savefig(path_out+"fig6_rev2"+figs_format2,bbox_inches='tight')
        plt.close(fig1)
