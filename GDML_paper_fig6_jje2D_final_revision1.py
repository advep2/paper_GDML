...
path_out = "VHT_MP_US_plume_sims/paper_GDML_figs/fig6_paper/new_sims/revision1/"
...
#    cont_ylabel = '$r$ (cm)'
    ...
    fig1.tight_layout()
    if save_flag == 1:
        fig1.savefig(path_out+"fig6_rev1"+figs_format,bbox_inches='tight')
        fig1.savefig(path_out+"fig6_rev1"+figs_format2,bbox_inches='tight')
        plt.close(fig1)
