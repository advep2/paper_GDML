...
#    xaxis_label_down =  r"$s/L_\mathrm{c}$"
    ...
    if plot_down == 1:
        ...
        text_C2 = 'C2'
        text_C3 = 'C3'
        axes1[1].text(zstext_phi_C1,rstext_phi_C1,text_C1,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[1].transAxes)  
        axes1[1].text(zstext_phi_C2,rstext_phi_C2,text_C2,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[1].transAxes)  
        axes1[1].text(zstext_phi_C3,rstext_phi_C3,text_C3,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[1].transAxes)  
        ...
        zstext_Te_C3 = 0.05
        rstext_Te_C3 = 0.07
        axes1[2].text(zstext_Te_C1,rstext_Te_C1,text_C1,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[2].transAxes)  
        axes1[2].text(zstext_Te_C2,rstext_Te_C2,text_C2,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[2].transAxes)  
        axes1[2].text(zstext_Te_C3,rstext_Te_C3,text_C3,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[2].transAxes)
...
#                ji_tot_b_plot[bIDfaces_wall][i]  = 0.0
    ...
    if save_flag == 1:
        ...
        fig1.savefig(path_out+"fig4"+figs_format,bbox_inches='tight')
        plt.close(fig1)
