...
path_out = "VHT_MP_US_plume_sims/paper_GDML_figs/fig8_paper/"
...
#    cont_ylabel = '$r$ (cm)'
    ...
    if plot_curr_ref == 1:
        ...
        [fig1, axes1] = plt.subplots(nrows=2, ncols=1, figsize=(7.5,12))
    ...
    #    yticks_lim = rs[-1,-1]+1
        ...
        #        lines_ticks_loc  = [(1.5,4.25),(3.4,4.25),(4.8,1.43),(7.56,7.4),(9.34,5.16),(8.45,0.6),(5.9,5.5),(4.0,6.4)]        
                ...
                #     if only_plume == 1:
                #         var[np.where(zs_mp < zs[0,int(xi_bottom)])] = np.nan
                #     [CS,CS2] = contour_2D (axes1[ind1],cont_xlabel, cont_ylabel, font_size, ticks_size, zs_mp, rs_mp, var, nodes_flag_mp, log_type, auto, 
                #                            min_val0, max_val0, cont, lines, cont_nlevels, auto_cbar_ticks, auto_lines_ticks,
                #                            nticks_cbar, nticks_lines, cbar_ticks, lines_ticks, lines_ticks_loc, cbar_ticks_fmt,
                #                            lines_ticks_fmt, lines_ticks_color, lines_style, lines_width) 
                # else:
                ...
                #     if only_plume == 1:
                #         var[:,0:int(xi_bottom)] = np.nan
                #     [CS,CS2] = contour_2D (axes1[ind1],cont_xlabel, cont_ylabel, font_size, ticks_size, zs, rs, var, nodes_flag, log_type, auto, 
                #                            min_val0, max_val0, cont, lines, cont_nlevels, auto_cbar_ticks, auto_lines_ticks,
                #                            nticks_cbar, nticks_lines, cbar_ticks, lines_ticks, lines_ticks_loc, cbar_ticks_fmt,
                #                            lines_ticks_fmt, lines_ticks_color, lines_style, lines_width) 
                var = np.copy(ji2D_plot)
        ...
        #        flag_start = 1
                ...
                #                                plot_start_points,streamline_density,streamline_width,streamline_color,arrow_size,
                #                                arrow_style,min_length)
                stream = streamline_2D(axes1[ind1],zvec,rvec,dims,zs,rs,ji_z_plot,ji_x_plot,flag_start,start_points,
                                               plot_start_points,streamline_density,streamline_width,streamline_color,arrow_size,
                                               arrow_style,min_length)
    ...
    fig1.tight_layout()
    if save_flag == 1:
        fig1.savefig(path_out+"fig8_ji2D_GP3C2_GP3C3"+figs_format,bbox_inches='tight')
        plt.close(fig1)
