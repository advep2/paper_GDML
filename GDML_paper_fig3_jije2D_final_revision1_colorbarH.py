...
path_out = "VHT_MP_US_plume_sims/paper_GDML_figs/fig3_paper/new_sims/revision1/"
...
#    cont_ylabel = '$r$ (cm)'
    ...
    if plot_curr_ref == 1:
        ...
        # [fig1, axes1] = plt.subplots(nrows=3, ncols=1, figsize=(7.5,18))
        [fig1, axes1] = plt.subplots(nrows=3, ncols=1, figsize=(7.5,15.5))
    ...
    #        flag_start = 1
            ...
            if ind1 == 1:
                axes1[ind1].tick_params(labelsize = ticks_size,labelbottom=False)
            elif ind1 == 2:
    ...
    fig1.tight_layout()
    if save_flag == 1:
        fig1.savefig(path_out+"fig3_rev1_colorbarH"+figs_format,bbox_inches='tight')
        fig1.savefig(path_out+"fig3_rev1_colorbarH"+figs_format2,bbox_inches='tight')
        plt.close(fig1)
