...
path_out = "VHT_MP_US_plume_sims/paper_GDML_figs/fig4_paper/"
...
#    plot_picM_picS_comp  = 0
    ...
    oldsimparams_sim = np.array([20,20,20,20,20,20,20,20,17,17,15,15,7,7,7,6,6,7,7,7,7,6,6,5,0],dtype = int)   
...
#                              "SPT100_picM_Reference1500points.hdf5",
    ...
    # Labels  
    labels1 = [ 
               # r"\phantom{-} $j_\mathrm{niP}$ P3G",
               # r"$-j_\mathrm{neP}$ P3G",
               # r"$j_\mathrm{niP}$ P3L",
               # r"$-j_\mathrm{neP}$ P3L",
               
               r"\phantom{-} $j_\mathrm{niP}$ P3GC",
               r"$-j_\mathrm{neP}$ P3GC",
               r"$j_\mathrm{niP}$ P3LC",
               r"$-j_\mathrm{neP}$ P3LC",
               ]                        
    labels2 = [
    ...
    labels3 = [ 
               # r"$P''_\mathrm{niP}$ P3G",
               # r"$P''_\mathrm{neP}$ P3G",
               # r"$P''_\mathrm{niP}$ P3L",
               # r"$P''_\mathrm{neP}$ P3L",
               
               r"$P''_\mathrm{niP}$ P3GC",
               r"$P''_\mathrm{neP}$ P3GC",
               r"$P''_\mathrm{niP}$ P3LC",
               r"$P''_\mathrm{neP}$ P3LC",
               ] 
...
#    xaxis_label_down =  r"$s/L_\mathrm{c}$"
    ...
    if plot_down == 1:
        ...
        axes1[1].set_yticks(np.arange(0,40+5,5))
        text = '(b)'
        # zstext = 1.1*3
        # rstext = 0.9*14
    ...
    for k in range(0,nsims):
        ...
        [num_ion_spe,num_neu_spe,points,zs,rs,zscells,rscells,dims,nodes_flag,
           ...
           delta_r,delta_s,delta_s_csl,dphi_sh_b,je_b,ji_tot_b,gp_net_b,ge_sb_b,relerr_je_b,
           ...
           err_interp_jez,err_interp_jer,n_inst,ni1_inst,ni2_inst,nn1_inst,Bfield,
           ...
           qi1_tot_wall_nodes,qi2_tot_wall_nodes,qi3_tot_wall_nodes,qi4_tot_wall_nodes,
           qi_tot_wall_nodes,qn1_tw_nodes,qn1_fw_nodes,qn2_tw_nodes,qn2_fw_nodes,
           qn3_tw_nodes,qn3_fw_nodes,qn_tot_wall_nodes,
           imp_ene_i1_nodes,imp_ene_i2_nodes,imp_ene_i3_nodes,imp_ene_i4_nodes,
           imp_ene_n1_nodes,imp_ene_n2_nodes,imp_ene_n3_nodes,Bfield_nodes,
           ...
           nQ2_inst_surf,nQ2_surf,dphi_kbc_surf,MkQ1_surf,ji1_surf,ji2_surf,ji3_surf,ji4_surf,
           ji_surf,gn1_tw_surf,gn1_fw_surf,gn2_tw_surf,gn2_fw_surf,gn3_tw_surf,
           gn3_fw_surf,gn_tw_surf,qi1_tot_wall_surf,qi2_tot_wall_surf,
           qi3_tot_wall_surf,qi4_tot_wall_surf,qi_tot_wall_surf,qn1_tw_surf,
           qn1_fw_surf,qn2_tw_surf,qn2_fw_surf,qn3_tw_surf,qn3_fw_surf,qn_tot_wall_surf,
           
           imp_ene_i1_surf,imp_ene_i2_surf,imp_ene_i3_surf,imp_ene_i4_surf,
           imp_ene_n1_surf,imp_ene_n2_surf,imp_ene_n3_surf,phi_inf] = HET_sims_read_bound(path_simstate_inp,path_simstate_out,path_postdata_out,path_simparams_inp,
        ...
        if mean_vars == 1:        
            ...
            [delta_r_mean,delta_s_mean,delta_s_csl_mean,dphi_sh_b_mean,je_b_mean,
               ...
               imp_ene_n3_surf_mean] = HET_sims_mean_bound(nsteps,mean_type,last_steps,step_i,step_f,delta_r,
                                                            ...
                                                            imp_ene_i3_surf,imp_ene_i4_surf,imp_ene_n1_surf,imp_ene_n2_surf,imp_ene_n3_surf)
        ...
        if mean_vars == 1 and plot_mean_vars == 1:
            ...
            [delta_r_plot,delta_s_plot,delta_s_csl_plot,dphi_sh_b_plot,je_b_plot,
               ...
               qe_b_fl_plot,relerr_qe_b_plot,relerr_qe_b_cons_plot,Te_plot,
               ...
               qe_b_bc_nodes_plot,qe_b_fl_nodes_plot,relerr_qe_b_nodes_plot,
               ...
               imp_ene_i3_surf_plot,imp_ene_i4_surf_plot,imp_ene_n1_surf_plot,
               imp_ene_n2_surf_plot,imp_ene_n3_surf_plot] = HET_sims_cp_vars_bound(delta_r_mean,delta_s_mean,delta_s_csl_mean,dphi_sh_b_mean,je_b_mean,ji_tot_b_mean,
            ...
            [delta_r_plot,delta_s_plot,delta_s_csl_plot,dphi_sh_b_plot,je_b_plot,
               ...
               qn_tot_wall_surf_plot,imp_ene_i1_surf_plot,imp_ene_i2_surf_plot,
               imp_ene_i3_surf_plot,imp_ene_i4_surf_plot,imp_ene_n1_surf_plot,
               imp_ene_n2_surf_plot,imp_ene_n3_surf_plot] = HET_sims_cp_vars_bound(delta_r,delta_s,delta_s_csl,dphi_sh_b,je_b,ji_tot_b,gp_net_b,ge_sb_b,
                                                                                  relerr_je_b,qe_tot_wall,qe_tot_s_wall,qe_tot_b,qe_b,
                                                                                  qe_b_bc,qe_b_fl,relerr_qe_b,relerr_qe_b_cons,Te,phi,
                                                                                  err_interp_phi,err_interp_Te,err_interp_jeperp,
                                                                                  err_interp_jetheta,err_interp_jepara,err_interp_jez,
                                                                                  ...
                                                                                  phi_nodes,err_interp_n_nodes,n_inst_nodes,ni1_inst_nodes,ni2_inst_nodes,
                                                                                  nn1_inst_nodes,n_nodes,ni1_nodes,ni2_nodes,nn1_nodes,dphi_kbc_nodes,
                                                                                  MkQ1_nodes,ji1_nodes,ji2_nodes,ji3_nodes,ji4_nodes,ji_nodes,gn1_tw_nodes,gn1_fw_nodes,
                                                                                  gn2_tw_nodes,gn2_fw_nodes,gn3_tw_nodes,gn3_fw_nodes,gn_tw_nodes,
                                                                                  qi1_tot_wall_nodes,qi2_tot_wall_nodes,qi3_tot_wall_nodes,qi4_tot_wall_nodes,
                                                                                  qi_tot_wall_nodes,qn1_tw_nodes,qn1_fw_nodes,qn2_tw_nodes,qn2_fw_nodes,
                                                                                  qn3_tw_nodes,qn3_fw_nodes,qn_tot_wall_nodes,imp_ene_i1_nodes,imp_ene_i2_nodes,
                                                                                  imp_ene_i3_nodes,imp_ene_i4_nodes,imp_ene_n1_nodes,imp_ene_n2_nodes,
                                                                                  imp_ene_n3_nodes,
                                                                                  ...
                                                                                  relerr_qe_b_cons_surf,Te_surf,phi_surf,nQ1_inst_surf,nQ1_surf,
                                                                                  nQ2_inst_surf,nQ2_surf,dphi_kbc_surf,MkQ1_surf,ji1_surf,ji2_surf,ji3_surf,ji4_surf,
                                                                                  ji_surf,gn1_tw_surf,gn1_fw_surf,gn2_tw_surf,gn2_fw_surf,gn3_tw_surf,gn3_fw_surf,
                                                                                  gn_tw_surf,qi1_tot_wall_surf,qi2_tot_wall_surf,qi3_tot_wall_surf,qi4_tot_wall_surf,
                                                                                  qi_tot_wall_surf,qn1_tw_surf,qn1_fw_surf,qn2_tw_surf,qn2_fw_surf,qn3_tw_surf,qn3_fw_surf,
                                                                                  qn_tot_wall_surf,imp_ene_i1_surf,imp_ene_i2_surf,imp_ene_i3_surf,imp_ene_i4_surf,
...
#        imp_ene_i1_nodes_plot  = imp_ene_i1_nodes_plot/e
#        imp_ene_i2_nodes_plot  = imp_ene_i2_nodes_plot/e
#        imp_ene_n1_nodes_plot  = imp_ene_n1_nodes_plot/e
#        imp_ene_ion_nodes_plot = imp_ene_i1_nodes_plot*(ni1_nodes_plot/n_nodes_plot) + imp_ene_i2_nodes_plot*(2*ni2_nodes_plot/n_nodes_plot)
...
#        imp_ene_ion_surf_plot  = imp_ene_i1_surf_plot*(ji1_surf_plot/ji_surf_plot) + imp_ene_i2_surf_plot*(ji2_surf_plot/ji_surf_plot)
        ...
        imp_ene_i1_nodes_plot  = (qi1_tot_wall_nodes_plot/(ji1_nodes_plot/e))/e
        imp_ene_i2_nodes_plot  = (qi2_tot_wall_nodes_plot/(ji2_nodes_plot/(2*e)))/e
        if num_ion_spe == 4:
            imp_ene_i3_nodes_plot  = (qi3_tot_wall_nodes_plot/(ji3_nodes_plot/e))/e
            imp_ene_i4_nodes_plot  = (qi4_tot_wall_nodes_plot/(ji4_nodes_plot/(2*e)))/e
#            imp_ene_ion_nodes_plot = imp_ene_i1_nodes_plot*(ni1_nodes_plot/n_nodes_plot) + imp_ene_i2_nodes_plot*(2*ni2_nodes_plot/n_nodes_plot) + imp_ene_i3_nodes_plot*(ni3_nodes_plot/n_nodes_plot) + imp_ene_i4_nodes_plot*(2*ni4_nodes_plot/n_nodes_plot)
#            imp_ene_ion_nodes_plot = imp_ene_i1_nodes_plot*(ji1_nodes_plot/ji_nodes_plot) + imp_ene_i2_nodes_plot*(ji2_nodes_plot/ji_nodes_plot) + imp_ene_i3_nodes_plot*(ji3_nodes_plot/ji_nodes_plot) + imp_ene_i4_nodes_plot*(ji4_nodes_plot/ji_nodes_plot)
            den = ji1_nodes_plot/e + ji2_nodes_plot/(2*e) + ji3_nodes_plot/e + ji4_nodes_plot/(2*e)
            imp_ene_ion_nodes_plot  = imp_ene_i1_nodes_plot*(ji1_nodes_plot/e/den) + imp_ene_i2_nodes_plot*(ji2_nodes_plot/(2*e)/den) + imp_ene_i3_nodes_plot*(ji3_nodes_plot/e/den) + imp_ene_i4_nodes_plot*(ji4_nodes_plot/(2*e)/den)
        elif num_ion_spe == 2:
#            imp_ene_ion_nodes_plot = imp_ene_i1_nodes_plot*(ji1_nodes_plot/ji_nodes_plot) + imp_ene_i2_nodes_plot*(ji2_nodes_plot/ji_nodes_plot)
            den = ji1_nodes_plot/e + ji2_nodes_plot/(2*e)
            imp_ene_ion_nodes_plot  = imp_ene_i1_nodes_plot*(ji1_nodes_plot/e/den) + imp_ene_i2_nodes_plot*(ji2_nodes_plot/(2*e)/den)
        imp_ene_ion_nodes_plot_v2 = qi_tot_wall_nodes_plot/(ji_nodes_plot/e)/e
        
        imp_ene_n1_nodes_plot  = qn1_tw_nodes_plot/(jn1_nodes_plot/e)/e
        if num_neu_spe == 1:
            imp_ene_n_nodes_plot    = imp_ene_n1_nodes_plot
            imp_ene_n_nodes_plot_v2 = imp_ene_n_nodes_plot
        if num_neu_spe == 3:
            imp_ene_n2_nodes_plot   = qn2_tw_nodes_plot/(jn2_nodes_plot/e)/e
            imp_ene_n3_nodes_plot   = qn3_tw_nodes_plot/(jn3_nodes_plot/e)/e
            imp_ene_n_nodes_plot    = imp_ene_n1_nodes_plot*(jn1_nodes_plot/jn_nodes_plot) + imp_ene_n2_nodes_plot*(jn2_nodes_plot/jn_nodes_plot) + imp_ene_n3_nodes_plot*(jn3_nodes_plot/jn_nodes_plot)
            imp_ene_n_nodes_plot_v2 = qn_tot_wall_nodes_plot/(jn_nodes_plot/e)/e
            
        imp_ene_i1_surf_plot   = (qi1_tot_wall_surf_plot/(ji1_surf_plot/e))/e
        imp_ene_i2_surf_plot   = (qi2_tot_wall_surf_plot/(ji2_surf_plot/(2*e)))/e
        if num_ion_spe == 4:
            imp_ene_i3_surf_plot   = (qi3_tot_wall_surf_plot/(ji3_surf_plot/e))/e
            imp_ene_i4_surf_plot   = (qi4_tot_wall_surf_plot/(ji4_surf_plot/(2*e)))/e
...
#            imp_ene_ion_surf_plot  = imp_ene_i1_surf_plot*(ji1_surf_plot/ji_surf_plot) + imp_ene_i2_surf_plot*(ji2_surf_plot/ji_surf_plot)
            ...
            imp_ene_ion_surf_plot  = imp_ene_i1_surf_plot*(ji1_surf_plot/e/den) + imp_ene_i2_surf_plot*(ji2_surf_plot/(2*e)/den)
        imp_ene_ion_surf_plot_v2 = qi_tot_wall_surf_plot/(ji_surf_plot/e)/e
        
        imp_ene_n1_surf_plot   = qn1_tw_surf_plot/(jn1_surf_plot/e)/e
        if num_neu_spe == 1:
            imp_ene_n_surf_plot    = imp_ene_n1_surf_plot
            imp_ene_n_surf_plot_v2 = imp_ene_n_surf_plot
        if num_neu_spe == 3:
            imp_ene_n2_surf_plot   = qn2_tw_surf_plot/(jn2_surf_plot/e)/e
            imp_ene_n3_surf_plot   = qn3_tw_surf_plot/(jn3_surf_plot/e)/e
        ...
        imp_ene_e_plot         = (qe_tot_wall_plot/(-je_b_plot/e))/e
        imp_ene_e_nodes_plot   = (qe_tot_wall_nodes_plot/(-je_b_nodes_plot/e))/e
        imp_ene_e_surf_plot    = (qe_tot_wall_surf_plot/(-je_b_surf_plot/e))/e
...
#                ji_tot_b_plot[bIDfaces_wall][i]  = 0.0
        ...
        if plot_down == 1:
            ...
            if plot_type == 0 or plot_type == 2:
                if k == 0:
                    axes1[0].semilogy(sdown,ji_tot_b_plot[bIDfaces_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels1[k])                
                    axes1[0].semilogy(sdown,-je_b_plot[bIDfaces_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels1[k+1])                
                elif k == 1:
                    axes1[0].semilogy(sdown,ji_tot_b_plot[bIDfaces_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels1[k+1])                
                    axes1[0].semilogy(sdown,-je_b_plot[bIDfaces_down], linestyle=linestyles[ind+2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+2], markeredgecolor = 'k', label=labels1[k+2])   
                axes1[1].plot(sdown,phi_plot[IDfaces_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                axes1[2].plot(sdown,Te_plot[IDfaces_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                if k == 0:
                    axes1[3].semilogy(sdown_surf,qi_tot_wall_surf_plot[indsurf_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels3[k])
                    axes1[3].semilogy(sdown,qe_tot_b_plot[bIDfaces_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels3[k+1])
                elif k == 1:
                    axes1[3].semilogy(sdown_surf,qi_tot_wall_surf_plot[indsurf_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels3[k+1])
                    axes1[3].semilogy(sdown,qe_tot_b_plot[bIDfaces_down], linestyle=linestyles[ind+2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+2], markeredgecolor = 'k', label=labels3[k+2])
            
            if plot_type == 1 and picvars_plot == 1:
                if k == 0:
                    axes1[0].semilogy(sdown_nodes,ji_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels1[k])
                    axes1[0].semilogy(sdown_nodes,-je_b_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels1[k+1])
                elif k == 1:
                    axes1[0].semilogy(sdown_nodes,ji_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels1[k+1])
                    axes1[0].semilogy(sdown_nodes,-je_b_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind+2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+2], markeredgecolor = 'k', label=labels1[k+2])
                axes1[1].plot(sdown_nodes,phi_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                axes1[2].plot(sdown_nodes,Te_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                if k == 0:
                    axes1[3].semilogy(sdown_nodes,qi_tot_wall_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels3[k])
                    axes1[3].semilogy(sdown_nodes,qe_tot_b_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels3[k+1])
                elif k == 1:
                    axes1[3].semilogy(sdown_nodes,qi_tot_wall_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels3[k+1])
                    axes1[3].semilogy(sdown_nodes,qe_tot_b_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind+2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+2], markeredgecolor = 'k', label=labels3[k+2])
    ...
    if plot_down == 1:
        ...
        axes1[0].legend(fontsize = font_size_legend,loc='best',ncol=1,frameon = True) 
        # legend = axes1[0].legend(fontsize = font_size_legend,loc='best',ncol=1,frameon = True) 
        axes1[1].legend(fontsize = font_size_legend,loc='best',ncol=2,frameon = True) 
        axes1[2].legend(fontsize = font_size_legend,loc='best',ncol=2,frameon = True) 
        axes1[3].legend(fontsize = font_size_legend,loc='best',ncol=1,frameon = True) 
    ...
    fig1.tight_layout()
    if save_flag == 1:
        fig1.savefig(path_out+"fig4_1Ds_1col_merged_linewidth2_C_cases"+figs_format,bbox_inches='tight')
        plt.close(fig1)
