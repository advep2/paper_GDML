...
#    last_steps      = 1000
    ...
    oldsimparams_sim = np.array([20,20,20,20,20,20,20,20,20,20,20,20],dtype = int)   
...
#        ax3.set_title(r"(d) $|\boldsymbol{B}|$ (G)", fontsize = font_size,y=1.02)   
    ...
    for k in range(0,nsims):
        ...
        if mean_vars == 1:        
            ...
            [phi_mean,Er_mean,Ez_mean,Efield_mean,nn1_mean,nn2_mean,nn3_mean,
               ...
               Te_elems_mean,Te_faces_mean,err_interp_n_mean,f_split_adv_mean,
               ...
               je_para_faces_mean,je_z_faces_mean,je_r_faces_mean] = HET_sims_mean(nsteps,mean_type,last_steps,step_i,step_f,Z_ion_spe,
                                                                                   ...
                                                                                   ndot_ion01_n3,ndot_ion02_n3,ndot_ion12_i3,ndot_CEX01_i3,ndot_CEX02_i4,
                                                                                   ne_cath,Te_cath,nu_cath,ndot_cath,F_theta,Hall_par,Hall_par_eff,nu_e_tot,
                                                                                   nu_e_tot_eff,nu_en,nu_ei1,nu_ei2,nu_i01,nu_i02,nu_i12,nu_ex,Boltz,
                                                                                   Boltz_dim,phi_elems,phi_faces,ne_elems,Te_elems,Te_faces,err_interp_n,
    ...
    #    yticks_lim = rs[-1,-1]+1
        ...
        if plot_curr_ref == 1:
            ...
            ax1.set_xticks(np.arange(0.0,xmax+1,1))
    ...
    #        nstart_z = 7
            ...
            ax3.set_xticks(np.arange(0,xmax+1,1))
            ...
            plt.tight_layout()
            if save_flag == 1:
                plt.savefig(path_out+"fig1_meshes_B_GDML_cathode"+figs_format,bbox_inches='tight')
                plt.close()
