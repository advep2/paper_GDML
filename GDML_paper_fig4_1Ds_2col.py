...
#    xaxis_label_down =  r"$s/L_\mathrm{c}$"
    ...
    if plot_down == 1:
        ...
        [fig1, axes1] = plt.subplots(nrows=3, ncols=2, figsize=(15,11))
        xlim = 31
        axes1[0,0].set_ylabel(r"$j_\mathrm{niP}$ (Acm$^{-2}$)",fontsize = font_size)
        # axes1[0,0].set_xlabel(prof_xlabel,fontsize = font_size)    
        axes1[0,0].set_xlim(0,xlim)
        axes1[0,0].set_xticks(np.arange(0,30+5,5))
        
        # axes1[0,0].yaxis.set_minor_locator(AutoMinorLocator(10))
        # axes1[0,0].set_yscale('log')
        
        axes1[0,0].set_ylim(1E-5,1E0)
        # axes1[0,0].set_ylim(1E-4,1E0)
        # axes1[0,0].yaxis.set_major_formatter(LogFormatter(minor_thresholds=(1, 10)))
        # axes1[0,0].set_yticklabels([1E-5,1E-4,1E-3,1E-2,1E-1,1E0])
        # axes1[0,0].set_yticks([0,5,10,15,20,25,30,35,40])
        text = '(a)'
        zstext = 0.07
        rstext = 0.90
        ...
        # axes1[0,0].tick_params(axis='y', which='minor')
        # axes1[0,0].xaxis.set_minor_locator(AutoMinorLocator(8))
        # axes1[0,0].tick_params(axis='y', which='minor', bottom=False)
        
        axes1[1,0].set_ylabel(r"$\phi_\mathrm{P}$ (V)",fontsize = font_size)
        # axes1[1,0].set_xlabel(prof_xlabel,fontsize = font_size)
        axes1[1,0].set_xlim(0,xlim)
        axes1[1,0].set_xticks(np.arange(0,30+5,5))
        axes1[1,0].set_ylim(0,12)
        # axes1[1,0].set_yticks([2,4,6,8,10,12,14])
        text = '(c)'
        # zstext = 1.1*3
        # rstext = 0.9*14
        ...
        axes1[2,0].set_ylabel(r"$P''_\mathrm{niP}$ (Wcm$^{-2}$)",fontsize = font_size)
        axes1[2,0].set_xlabel(prof_xlabel,fontsize = font_size)
        axes1[2,0].set_xlim(0,xlim)
        axes1[2,0].set_xticks(np.arange(0,30+5,5))
        axes1[2,0].set_ylim(1E-4,1E2)
        ...
        axes1[0,1].set_ylabel(r"$-j_\mathrm{neP}$ (Acm$^{-2}$)",fontsize = font_size)
        # axes1[0,1].set_xlabel(prof_xlabel,fontsize = font_size)    
        axes1[0,1].set_xlim(0,xlim)
        axes1[0,1].set_xticks(np.arange(0,30+5,5))
        axes1[0,1].set_ylim(1E-5,1E0)
        # axes1[0,1].set_yticks([0,10,20,30,40])
        # axes1[0,1].set_yticks([0,5,10,15,20,25,30,35,40])
        text = '(b)'
        # zstext = 1.1*3
        # rstext = 0.9*40
        ...
        axes1[1,1].set_ylabel(r"$T_\mathrm{eP}$ (eV)",fontsize = font_size)
        # axes1[1,1].set_xlabel(prof_xlabel,fontsize = font_size)
        axes1[1,1].set_xlim(0,xlim)
        axes1[1,1].set_xticks(np.arange(0,30+5,5))
        axes1[1,1].set_ylim(0,5)
        # axes1[1,1].set_yticks([2,4,6,8,10,12,14])
        text = '(d)'
        # zstext = 1.1*3
        # rstext = 0.9*14
        ...
        axes1[2,1].set_ylabel(r"$P''_\mathrm{neP}$ (Wcm$^{-2}$)",fontsize = font_size)
        axes1[2,1].set_xlabel(prof_xlabel,fontsize = font_size)
        axes1[2,1].set_xlim(0,xlim)
        axes1[2,1].set_xticks(np.arange(0,30+5,5))
        axes1[2,1].set_ylim(1E-4,1E2)
...
#                ji_tot_b_plot[bIDfaces_wall][i]  = 0.0
        ...
        if plot_down == 1:
            ...
            if plot_type == 0 or plot_type == 2:
                axes1[0,0].semilogy(sdown,ji_tot_b_plot[bIDfaces_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])                
                axes1[0,1].semilogy(sdown,-je_b_plot[bIDfaces_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])                
                axes1[1,0].plot(sdown,phi_plot[IDfaces_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[1,1].plot(sdown,Te_plot[IDfaces_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[2,0].semilogy(sdown_surf,qi_tot_wall_surf_plot[indsurf_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[2,1].semilogy(sdown,qe_tot_b_plot[bIDfaces_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
            if plot_type == 1 and picvars_plot == 1:
                axes1[0,0].semilogy(sdown_nodes,ji_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[0,1].semilogy(sdown_nodes,-je_b_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[1,0].plot(sdown_nodes,phi_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[1,1].plot(sdown_nodes,Te_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[2,0].semilogy(sdown_nodes,qi_tot_wall_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
                axes1[2,1].semilogy(sdown_nodes,qe_tot_b_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels[k])
    ...
    if plot_down == 1:
        axes1[0,0].axvline(x=Lfreeloss_ver, linestyle=':',color='k', linewidth = line_width)
        axes1[1,0].axvline(x=Lfreeloss_ver, linestyle=':',color='k', linewidth = line_width)
        axes1[2,0].axvline(x=Lfreeloss_ver, linestyle=':',color='k', linewidth = line_width)
        axes1[0,1].axvline(x=Lfreeloss_ver, linestyle=':',color='k', linewidth = line_width)
        axes1[1,1].axvline(x=Lfreeloss_ver, linestyle=':',color='k', linewidth = line_width)
        axes1[2,1].axvline(x=Lfreeloss_ver, linestyle=':',color='k', linewidth = line_width)
        
        axes1[0,0].axvline(x=rs[rind,0], linestyle='--',color='k', linewidth = line_width)
        axes1[1,0].axvline(x=rs[rind,0], linestyle='--',color='k', linewidth = line_width)
        axes1[2,0].axvline(x=rs[rind,0], linestyle='--',color='k', linewidth = line_width)
        axes1[0,1].axvline(x=rs[rind,0], linestyle='--',color='k', linewidth = line_width)
        axes1[1,1].axvline(x=rs[rind,0], linestyle='--',color='k', linewidth = line_width)
        axes1[2,1].axvline(x=rs[rind,0], linestyle='--',color='k', linewidth = line_width)
            
            

    fig1.tight_layout()
    if save_flag == 1:
        fig1.savefig(path_out+"fig4_1Ds_2col"+figs_format,bbox_inches='tight')
        plt.close(fig1)
