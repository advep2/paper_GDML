...
path_out = "VHT_MP_US_plume_sims/paper_GDML_figs/fig3_paper/"
...
#    cont_ylabel = '$r$ (cm)'
    ...
    #        flag_start = 1
            ...
            if ax_ticks_flag == 2:
                ...
                axes1[ind1].set_yticks(np.arange(0,ylim_axes,1))
    ...
    fig1.tight_layout()
    if save_flag == 1:
        fig1.savefig(path_out+"fig3_je2D_P3LG"+figs_format,bbox_inches='tight')
        plt.close(fig1)
