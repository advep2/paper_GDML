...
path_out = "VHT_MP_US_plume_sims/paper_GDML_figs/fig4_paper/new_sims/revision1/"
...
#    xaxis_label_down =  r"$s/L_\mathrm{c}$"
    ...
    if plot_down == 1:
        ...
        [fig1, axes1] = plt.subplots(nrows=4, ncols=1, figsize=(8,13.33))
        # [fig1, axes1] = plt.subplots(nrows=3, ncols=1, figsize=(8,10))  
        # [fig1, axes1] = plt.subplots(nrows=3, ncols=1, figsize=(8,14))  
        xlim = 31
        ...
        axes1[0].set_ylabel(r"$\phi_\mathrm{P}$ (V)",fontsize = font_size)
        # axes1[0].set_xlabel(prof_xlabel,fontsize = font_size)
        axes1[0].set_xlim(0,xlim)
        axes1[0].set_xticks(np.arange(0,30+5,5))
        axes1[0].set_ylim(-5,40)
        axes1[0].set_yticks(np.arange(-5,40+5,5))
        text = '(a)'
        axes1[0].text(zstext,rstext,text,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[0].transAxes)  
        zstext_Pver = 0.3
        rstext_Pver = 0.9
        ...
        # rstext_Plat = 1.05
        text = 'Axial'
        axes1[0].text(zstext_Pver,rstext_Pver,text,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[0].transAxes)  
        text = 'Lateral'
        axes1[0].text(zstext_Plat,rstext_Plat,text,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[0].transAxes)  
        zstext_phi_C2 = 0.15
        rstext_phi_C2 = 0.65
        zstext_phi_C1 = 0.04
        rstext_phi_C1 = 0.5
        ...
        text_C2 = 'C2'
        text_C3 = 'C3'
        axes1[0].text(zstext_phi_C1,rstext_phi_C1,text_C1,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[0].transAxes)  
        axes1[0].text(zstext_phi_C2,rstext_phi_C2,text_C2,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[0].transAxes)  
        axes1[0].text(zstext_phi_C3,rstext_phi_C3,text_C3,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[0].transAxes)  
        axes1[0].tick_params(labelsize = ticks_size,labelbottom=False)
        
        # # Do figure inside phi figure with inset
        # axins_phi = inset_axes(axes1[0], width="100%", height="100%", bbox_to_anchor=(0.57, 0.5, 0.25, 0.4),
        #                       bbox_transform=axes1[0].transAxes, loc='lower left')
        # axins_phi.set_yticks([0,5,10,15])
        # axins_phi.set_xticks(np.arange(0,30+5,5))
        # axins_phi.tick_params(labelsize = ticks_size)
        
        
        axes1[1].set_ylabel(r"$T_\mathrm{eP}$ (eV)",fontsize = font_size)
        # axes1[1].set_xlabel(prof_xlabel,fontsize = font_size)
        axes1[1].set_xlim(0,xlim)
        axes1[1].set_xticks(np.arange(0,30+5,5))
        axes1[1].set_ylim(0,14)
        axes1[1].set_yticks(np.arange(0,14+2,2))
        text = '(b)'
        axes1[1].text(zstext,rstext,text,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[1].transAxes)  
        text = 'Axial'
        axes1[1].text(zstext_Pver,rstext_Pver,text,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[1].transAxes)  
        text = 'Lateral'
        axes1[1].text(zstext_Plat,rstext_Plat,text,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[1].transAxes) 
        zstext_Te_C2 = 0.2
        rstext_Te_C2 = 0.65
        zstext_Te_C1 = 0.05
        rstext_Te_C1 = 0.28
        zstext_Te_C3 = 0.05
        rstext_Te_C3 = 0.06
        axes1[1].text(zstext_Te_C1,rstext_Te_C1,text_C1,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[1].transAxes)  
        axes1[1].text(zstext_Te_C2,rstext_Te_C2,text_C2,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[1].transAxes)  
        axes1[1].text(zstext_Te_C3,rstext_Te_C3,text_C3,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[1].transAxes)
        axes1[1].tick_params(labelsize = ticks_size,labelbottom=False)
        
        # Do figure inside Te figure with inset
        axins_Te = inset_axes(axes1[1], width="100%", height="100%", bbox_to_anchor=(0.58, 0.30, 0.4, 0.5),
                              bbox_transform=axes1[1].transAxes, loc='lower left')
        axins_Te.set_yticks([0,0.5,1,1.5,2,2.5,3,3.5,4])
        axins_Te.set_xticks(np.arange(0,30+5,5))
        axins_Te.tick_params(labelsize = ticks_size)
        
        # Optional: remove ticks on inset
        # axins_Te.set_xticks([])
        # axins_Te.set_yticks([])
        # Connecting lines for the inset
        # mark_inset(axes1[1], axins_Te, loc1=1, loc2=2, fc="none", ec="0.5")
        
        # Figure of ji3 in log y scale
        ...
        axes1[2].set_ylabel(r"$j_\mathrm{niP}^\mathrm{CEX, \, Xe+}$ (Acm$^{-2}$)",fontsize = font_size)
        # axes1[2].set_xlabel(prof_xlabel,fontsize = font_size)
        axes1[2].set_xlim(0,xlim)
        axes1[2].set_xticks(np.arange(0,30+5,5))
        axes1[2].set_ylim(0,70)
        axes1[2].set_ylim(1E-6,1E-3)
        text = '(c)'
        axes1[2].text(zstext,rstext,text,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[2].transAxes)  
        text = 'Axial'
        axes1[2].text(zstext_Pver,rstext_Pver,text,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[2].transAxes)  
        text = 'Lateral'
        axes1[2].text(zstext_Plat,rstext_Plat,text,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[2].transAxes) 
        axes1[2].tick_params(labelsize = ticks_size,labelbottom=False)
        
        # Do figure inside ji3 figure with inset
        # axins_ji3 = inset_axes(axes1[2], width="100%", height="100%", bbox_to_anchor=(0.62, 0.37, 0.35, 0.5),
        #                       bbox_transform=axes1[2].transAxes, loc='lower left')
        axins_ji3 = inset_axes(axes1[2], width="100%", height="100%", bbox_to_anchor=(0.60, 0.37, 0.38, 0.5),
                              bbox_transform=axes1[2].transAxes, loc='lower left')
        axins_ji3.set_ylim(1E-6,1E-5)
        axins_ji3.set_xticks(np.arange(0,30+5,5))
        axins_ji3.tick_params(labelsize = ticks_size)
        
        # Make inset transparent
        axins_ji3.patch.set_alpha(0)
        
        # Optional: remove inset frame line
        axins_ji3.spines['top'].set_visible(False)
        axins_ji3.spines['right'].set_visible(False)
        # for spine in axins_ji3.spines.values():
        #     spine.set_visible(False)
        
        axes1[3].set_ylabel(r"$\mathcal{E}_\mathrm{niP}^\mathrm{CEX, \, Xe+}$ (eV)",fontsize = font_size)
        axes1[3].set_xlabel(prof_xlabel,fontsize = font_size)
        axes1[3].set_xlim(0,xlim)
        axes1[3].set_xticks(np.arange(0,30+5,5))
        # axes1[3].set_ylim(50,300)
        # axes1[3].set_yticks(np.arange(50,300+25,25))
        axes1[3].set_ylim(40,260)
        # axes1[3].set_yticks(np.arange(40,260+20,20))
        axes1[3].set_yticks(np.arange(40,260+40,40))
        text = '(d)'
        axes1[3].text(zstext,rstext,text,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[3].transAxes)  
        text = 'Axial'
        axes1[3].text(zstext_Pver,rstext_Pver,text,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[3].transAxes)  
        text = 'Lateral'
        axes1[3].text(zstext_Plat,rstext_Plat,text,fontsize = text_size,color='k',ha='center',va='center',transform=axes1[3].transAxes) 
        axes1[3].tick_params(labelsize = ticks_size)
        
        # # Do figure inside Te figure with inset
        # axins_Ei3 = inset_axes(axes1[3], width="100%", height="100%", bbox_to_anchor=(0.58, 0.30, 0.4, 0.5),
        #                       bbox_transform=axes1[3].transAxes, loc='lower left')
        # axins_Ei3.set_yticks([50,75,100,125,150])
        # axins_Ei3.set_xticks(np.arange(0,30+5,5))
        # axins_Ei3.tick_params(labelsize = ticks_size)
...
#        jnodes_down = np.concatenate((jnodes_FLwall_lat,np.flip(jnodes_FLwall_ver)),axis=0)
        ...
        print("Energies at P boundary (mean of imp_ene from HYPHEN)")
        ...
        print("Energies at P boundary (value computed as P/g using averaged quantities)")
...
#                ji_tot_b_plot[bIDfaces_wall][i]  = 0.0
        ...
        if plot_down == 1:
            ...
            if plot_type == 0 or plot_type == 2:
                ...
                if k == 0:
                    phi_P3LC3     = phi_plot[IDfaces_down]
                    Te_P3LC3      = Te_plot[IDfaces_down]
                    ji3_P3LC3     = ji3_surf_plot[indsurf_down]
                    Ei3_P3LC3     = imp_ene_i3_surf_plot[indsurf_down]
                    avg_Ei3_P3LC3 = avg_imp_ene_i3_surf_plot[indsurf_down]
                elif k == 1:
                    phi_P3GC3     = phi_plot[IDfaces_down]
                    Te_P3GC3      = Te_plot[IDfaces_down]
                    ji3_P3GC3     = ji3_surf_plot[indsurf_down]
                    Ei3_P3GC3     = imp_ene_i3_surf_plot[indsurf_down]
                    avg_Ei3_P3GC3 = avg_imp_ene_i3_surf_plot[indsurf_down]
                elif k == 2:
                    phi_P3LC2     = phi_plot[IDfaces_down]
                    Te_P3LC2      = Te_plot[IDfaces_down]
                    ji3_P3LC2     = ji3_surf_plot[indsurf_down]
                    Ei3_P3LC2     = imp_ene_i3_surf_plot[indsurf_down]
                    avg_Ei3_P3LC2 = avg_imp_ene_i3_surf_plot[indsurf_down]
                elif k == 3:
                    phi_P3GC2     = phi_plot[IDfaces_down]
                    Te_P3GC2      = Te_plot[IDfaces_down]
                    ji3_P3GC2     = ji3_surf_plot[indsurf_down]
                    Ei3_P3GC2     = imp_ene_i3_surf_plot[indsurf_down]
                    avg_Ei3_P3GC2 = avg_imp_ene_i3_surf_plot[indsurf_down]
                elif k == 4:
                    phi_P3LC1     = phi_plot[IDfaces_down]
                    Te_P3LC1      = Te_plot[IDfaces_down]
                    ji3_P3LC1     = ji3_surf_plot[indsurf_down]
                    Ei3_P3LC1     = imp_ene_i3_surf_plot[indsurf_down]
                    avg_Ei3_P3LC1 = avg_imp_ene_i3_surf_plot[indsurf_down]
                elif k == 5:
                    phi_P3GC1     = phi_plot[IDfaces_down]
                    Te_P3GC1      = Te_plot[IDfaces_down]
                    ji3_P3GC1     = ji3_surf_plot[indsurf_down]
                    Ei3_P3GC1     = imp_ene_i3_surf_plot[indsurf_down]
                    avg_Ei3_P3GC1 = avg_imp_ene_i3_surf_plot[indsurf_down]
                
                # Figures of phi and Te
                if k == 0 or k == 1:    
                    axes1[0].plot(sdown,phi_plot[IDfaces_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                    # axins_phi.plot(sdown,phi_plot[IDfaces_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                    # if k == 0:
                ...
                # if k == 0:
                    ...
                    axes1[1].plot(sdown,Te_plot[IDfaces_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                    axins_Te.plot(sdown,Te_plot[IDfaces_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                elif k == 2 or k == 3:
                    axes1[0].plot(sdown,phi_plot[IDfaces_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                    # axins_phi.plot(sdown,phi_plot[IDfaces_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                    # if k == 2:
                ...
                # Figure of ji3 in log y scale
                if k == 0:
                    # axes1[2].plot(sdown_surf,imp_ene_i3_surf_plot[indsurf_down]/factor_divide_ene_ion, linestyle='--', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                    axes1[2].semilogy(sdown_surf,ji3_surf_plot[indsurf_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                    axins_ji3.semilogy(sdown_surf,ji3_surf_plot[indsurf_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                elif k == 1:
                    # axes1[2].plot(sdown_surf,imp_ene_i3_surf_plot[indsurf_down]/factor_divide_ene_ion, linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                    axes1[2].semilogy(sdown_surf,ji3_surf_plot[indsurf_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                    axins_ji3.semilogy(sdown_surf,ji3_surf_plot[indsurf_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                ...
                # Figure of Ei3 in linear y scale
                # axes1[3].plot(sdown_surf,imp_ene_i3_surf_plot[indsurf_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                # axins_Ei3.plot(sdown_surf,imp_ene_i3_surf_plot[indsurf_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                axes1[3].plot(sdown_surf,avg_imp_ene_i3_surf_plot[indsurf_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
                # axins_Ei3.plot(sdown_surf,avg_imp_ene_i3_surf_plot[indsurf_down], linestyle='-', linewidth = line_width, markevery=marker_every_vec[ind], markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels2[k])
    ...
    if plot_down == 1:
        ...
        # axes1[0].legend([lines1_flip1[i] for i in range(0,len(lines1_flip1))], [lines1_flip1[i].get_label() for i in range(0,len(lines1_flip1))],fontsize = font_size_legend+3,loc='upper center',bbox_to_anchor=(0.5, 1.30),ncol=3,frameon = True,numpoints=2,handlelength=2.9,borderpad=0.25,columnspacing=1) 
        axes1[3].legend([lines1_flip1[i] for i in range(0,len(lines1_flip1))], [lines1_flip1[i].get_label() for i in range(0,len(lines1_flip1))],fontsize = font_size_legend+3,loc='upper center',bbox_to_anchor=(0.5, -0.25),ncol=3,frameon = True,numpoints=2,handlelength=2.9,borderpad=0.25,columnspacing=1) 
        ...
        # Definir región a mostrar en el inset
        # x1, x2, y1, y2               = Lfreeloss_ver, sdown_surf[-1], 0, 2
        # x1_phi, x2_phi, y1_phi, y2_phi = 25, sdown_surf[-1], -2, 15
        # axins_phi.set_xlim(x1_phi, x2_phi)
        # axins_phi.set_ylim(y1_phi, y2_phi)
        x1_Te, x2_Te, y1_Te, y2_Te     = 15, sdown_surf[-1], 0, 2
        axins_Te.set_xlim(x1_Te, x2_Te)
        axins_Te.set_ylim(y1_Te, y2_Te)
        x1_ji3, x2_ji3, y1_ji3, y2_ji3 = 15, sdown_surf[-1], 1E-6, 1E-5
        axins_ji3.set_xlim(x1_ji3, x2_ji3)
        axins_ji3.set_ylim(y1_ji3, y2_ji3)
        # x1_Ei3, x2_Ei3, y1_Ei3, y2_Ei3 = 15, sdown_surf[-1], 50, 150
        # axins_Ei3.set_xlim(x1_Ei3, x2_Ei3)
        # axins_Ei3.set_ylim(y1_Ei3, y2_Ei3)
        
        ind_lat = 45
        dphi_C1          = phi_P3LC1[ind_lat::]-phi_P3GC1[ind_lat::]
        dTe_C1           = Te_P3LC1[ind_lat::]-Te_P3GC1[ind_lat::]
        dji3_C1          = ji3_P3LC1[ind_lat::]-ji3_P3GC1[ind_lat::]
        dEi3_C1          = Ei3_P3LC1[ind_lat::] - Ei3_P3GC1[ind_lat::] 
        avg_dEi3_C1      = avg_Ei3_P3LC1[ind_lat::] - avg_Ei3_P3GC1[ind_lat::] 
        err_C1_phi       = dphi_C1/phi_P3GC1[ind_lat::]*100
        err_C1_Te        = dTe_C1/Te_P3GC1[ind_lat::]*100
        err_C1_ji3       = dji3_C1/ji3_P3GC1[ind_lat::]*100
        err_C1_Ei3       = dEi3_C1/Ei3_P3GC1[ind_lat::]*100
        err_C1_avg_Ei3   = avg_dEi3_C1/avg_Ei3_P3GC1[ind_lat::]*100
        ratio_dphi_Te_C1 = dphi_C1/Te_P3GC1[ind_lat::]
        

    fig1.tight_layout()
    if save_flag == 1:
        # fig1.savefig(path_out+"fig4_1Ds_1col_merged_linewidth2_ene"+figs_format,bbox_inches='tight')
        fig1.savefig(path_out+"fig4_rev1_Ei3"+figs_format,bbox_inches='tight')
        fig1.savefig(path_out+"fig4_rev1_Ei3"+figs_format2,bbox_inches='tight')
        plt.close(fig1)
