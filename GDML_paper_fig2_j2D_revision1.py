...
path_out = "VHT_MP_US_plume_sims/paper_GDML_figs/fig2_paper/figs_only_plume/new_sims/revision1/"
...
#         if k == 1 or k == 3 or k == 5:
    ...
    # Add horizontal colorbar common to the complete figure
    ...
    fig3.tight_layout()
    if save_flag == 1:
        fig3.savefig(path_out+"fig2_rev1"+figs_format,bbox_inches='tight')
        fig3.savefig(path_out+"fig2_rev1"+figs_format2,bbox_inches='tight')
        plt.close(fig3)
