...
#                ji_tot_b_plot[bIDfaces_wall][i]  = 0.0
        ...
        if plot_down == 1:
            ...
            if plot_type == 0 or plot_type == 2:
                if k == 0:
                    ...
                    axes1[0].semilogy(sdown,ji_tot_b_plot[bIDfaces_down], linestyle=linestyles[ind-2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind-2], markeredgecolor = 'k', label=labels1[k+2])                
                    axes1[0].semilogy(sdown,-je_b_plot[bIDfaces_down], linestyle=linestyles[ind+1-2], linewidth = line_width, markevery=marker_every-1, markersize=marker_size, marker=markers[ind], color=colors[ind+1-2], markeredgecolor = 'k', label=labels1[k+1+2])                
                elif k == 3:
                    axes1[0].semilogy(sdown,ji_tot_b_plot[bIDfaces_down], linestyle=linestyles[ind+1-2], linewidth = line_width, markevery=marker_every-2, markersize=marker_size, marker=markers[ind], color=colors[ind+1-2], markeredgecolor = 'k', label=labels1[k+1+2])                
                    axes1[0].semilogy(sdown,-je_b_plot[bIDfaces_down], linestyle=linestyles[ind+2-2], linewidth = line_width, markevery=marker_every-3, markersize=marker_size, marker=markers[ind], color=colors[ind+2-2], markeredgecolor = 'k', label=labels1[k+2+2])   
                elif k == 4:
                    axes1[0].semilogy(sdown,ji_tot_b_plot[bIDfaces_down], linestyle=linestyles[ind-4], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind-4], markeredgecolor = 'k', label=labels1[k+2+2])                
                    axes1[0].semilogy(sdown,-je_b_plot[bIDfaces_down], linestyle=linestyles[ind+1-4], linewidth = line_width, markevery=marker_every-1, markersize=marker_size, marker=markers[ind], color=colors[ind+1-4], markeredgecolor = 'k', label=labels1[k+1+2+2])                
                elif k == 5:
                    axes1[0].semilogy(sdown,ji_tot_b_plot[bIDfaces_down], linestyle=linestyles[ind+1-4], linewidth = line_width, markevery=marker_every-2, markersize=marker_size, marker=markers[ind], color=colors[ind+1-4], markeredgecolor = 'k', label=labels1[k+1+2+2])                
                    axes1[0].semilogy(sdown,-je_b_plot[bIDfaces_down], linestyle=linestyles[ind+2-4], linewidth = line_width, markevery=marker_every-3, markersize=marker_size, marker=markers[ind], color=colors[ind+2-4], markeredgecolor = 'k', label=labels1[k+2+2+2])   
                ...
                # if k == 0:
                    ...
                    axes1[1].plot(sdown,phi_plot[IDfaces_down], linestyle=linestyles[ind-2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind-2], markeredgecolor = 'k', label=labels2[k])
                    # if k == 2:
                    ...
                    axes1[2].plot(sdown,Te_plot[IDfaces_down], linestyle=linestyles[ind-2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind-2], markeredgecolor = 'k', label=labels2[k])
                elif k == 4 or k == 5:
                    axes1[1].plot(sdown,phi_plot[IDfaces_down], linestyle=linestyles[ind-4], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind-4], markeredgecolor = 'k', label=labels2[k])
                    # if k == 2:
                    #     axes1[1].plot(sdown_nodes,phi_nodes_plot[inodes_down,jnodes_down], linestyle=':', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color='c', markeredgecolor = 'k', label="")
                    # elif k == 3:
                    #     axes1[1].plot(sdown_nodes,phi_nodes_plot[inodes_down,jnodes_down], linestyle=':', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color='y', markeredgecolor = 'k', label="")
                    axes1[2].plot(sdown,Te_plot[IDfaces_down], linestyle=linestyles[ind-4], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind-4], markeredgecolor = 'k', label=labels2[k])
                
                # Figure of energy in linear y scale
                if k == 0:
                    axes1[3].plot(sdown_surf,avg_imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels3[k])
                    ...
                    axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels3[k+1])
                    ...
                    axes1[3].plot(sdown_surf,avg_imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels3[k+1])
                    ...
                    axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle=linestyles[ind+2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+2], markeredgecolor = 'k', label=labels3[k+2])
                    ...
                    axes1[3].plot(sdown_surf,avg_imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle=linestyles[ind-2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind-2], markeredgecolor = 'k', label=labels3[k+2])
                    # axes1[3].plot(sdown_surf,imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle='--', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color='y', markeredgecolor = 'k', label="")
                    axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle=linestyles[ind+1-2], linewidth = line_width, markevery=marker_every-1, markersize=marker_size, marker=markers[ind], color=colors[ind+1-2], markeredgecolor = 'k', label=labels3[k+1+2])
                    # axes1[3].plot(sdown,avg_imp_ene_e_b_plot[bIDfaces_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels3[k+1])
                    # axes1[3].plot(sdown,imp_ene_e_b_plot[bIDfaces_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels3[k+1])
                    # axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle='--', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'c', label=r"$T_\mathrm{eP}\left(2+\frac{\phi_{\infty P}}{T_\mathrm{eP}}\right)$")
                elif k == 3:
                    axes1[3].plot(sdown_surf,avg_imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle=linestyles[ind+1-2], linewidth = line_width, markevery=marker_every-2, markersize=marker_size, marker=markers[ind], color=colors[ind+1-2], markeredgecolor = 'k', label=labels3[k+1+2])
                    # axes1[3].plot(sdown_surf,imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle='--', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color='c', markeredgecolor = 'k', label="")
                    axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle=linestyles[ind+2-2], linewidth = line_width, markevery=marker_every-3, markersize=marker_size, marker=markers[ind], color=colors[ind+2-2], markeredgecolor = 'k', label=labels3[k+2+2])
                    # axes1[3].plot(sdown,avg_imp_ene_e_b_plot[bIDfaces_down], linestyle=linestyles[ind+2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+2], markeredgecolor = 'k', label=labels3[k+2])
                    # axes1[3].plot(sdown,imp_ene_e_b_plot[bIDfaces_down], linestyle=linestyles[ind+2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+2], markeredgecolor = 'k', label=labels3[k+2])
                    # axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle='-.', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=r"4.5$T_\mathrm{eP}$")
                elif k == 4:
                    axes1[3].plot(sdown_surf,avg_imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle=linestyles[ind-4], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind-4], markeredgecolor = 'k', label=labels3[k+2+2])
                    # axes1[3].plot(sdown_surf,imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle='--', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color='y', markeredgecolor = 'k', label="")
                    axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle=linestyles[ind+1-4], linewidth = line_width, markevery=marker_every-1, markersize=marker_size, marker=markers[ind], color=colors[ind+1-4], markeredgecolor = 'k', label=labels3[k+1+2+2])
                    # axes1[3].plot(sdown,avg_imp_ene_e_b_plot[bIDfaces_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels3[k+1])
                    # axes1[3].plot(sdown,imp_ene_e_b_plot[bIDfaces_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels3[k+1])
                    # axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle='--', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'c', label=r"$T_\mathrm{eP}\left(2+\frac{\phi_{\infty P}}{T_\mathrm{eP}}\right)$")
                elif k == 5:
                    axes1[3].plot(sdown_surf,avg_imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle=linestyles[ind+1-4], linewidth = line_width, markevery=marker_every-2, markersize=marker_size, marker=markers[ind], color=colors[ind+1-4], markeredgecolor = 'k', label=labels3[k+1+2+2])
                    # axes1[3].plot(sdown_surf,imp_ene_ion_surf_v2_plot[indsurf_down]/factor_divide_ene_ion, linestyle='--', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color='c', markeredgecolor = 'k', label="")
                    axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle=linestyles[ind+2-4], linewidth = line_width, markevery=marker_every-3, markersize=marker_size, marker=markers[ind], color=colors[ind+2-4], markeredgecolor = 'k', label=labels3[k+2+2+2])
                    # axes1[3].plot(sdown,avg_imp_ene_e_b_plot[bIDfaces_down], linestyle=linestyles[ind+2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+2], markeredgecolor = 'k', label=labels3[k+2])
                    # axes1[3].plot(sdown,imp_ene_e_b_plot[bIDfaces_down], linestyle=linestyles[ind+2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+2], markeredgecolor = 'k', label=labels3[k+2])
                    # axes1[3].plot(sdown,imp_ene_e_b_down_check_v2, linestyle='-.', linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=r"4.5$T_\mathrm{eP}$")
            ...
            if plot_type == 1 and picvars_plot == 1:
                ...
                if k == 0:
                    axes1[3].semilogy(sdown_nodes,avg_imp_ene_ion_nodes_v2_plot[inodes_down,jnodes_down], linestyle=linestyles[ind], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind], markeredgecolor = 'k', label=labels3[k])
                    axes1[3].semilogy(sdown_nodes,avg_imp_ene_e_b_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels3[k+1])
                elif k == 1:
                    axes1[3].semilogy(sdown_nodes,avg_imp_ene_ion_nodes_v2_plot[inodes_down,jnodes_down], linestyle=linestyles[ind+1], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+1], markeredgecolor = 'k', label=labels3[k+1])
                    axes1[3].semilogy(sdown_nodes,avg_imp_ene_e_b_nodes_plot[inodes_down,jnodes_down], linestyle=linestyles[ind+2], linewidth = line_width, markevery=marker_every, markersize=marker_size, marker=markers[ind], color=colors[ind+2], markeredgecolor = 'k', label=labels3[k+2])
    ...
    if save_flag == 1:
        ...
        fig1.savefig(path_out+"fig4_1Ds_P3_C1_C3"+figs_format,bbox_inches='tight')
        plt.close(fig1)
