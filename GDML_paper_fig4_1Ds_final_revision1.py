...
#    xaxis_label_down =  r"$s/L_\mathrm{c}$"
    ...
    if plot_down == 1:
        ...
        axes1[2].tick_params(labelsize = ticks_size)
...
#                ji_tot_b_plot[bIDfaces_wall][i]  = 0.0
    ...
    if plot_down == 1:
        ...
        axes1[2].legend([lines1_flip1[i] for i in range(0,len(lines1_flip1))], [lines1_flip1[i].get_label() for i in range(0,len(lines1_flip1))],fontsize = font_size_legend+3,loc='upper center',bbox_to_anchor=(0.5, -0.25),ncol=3,frameon = True,numpoints=2,handlelength=2.9,borderpad=0.25,columnspacing=1) 
    ...
    if save_flag == 1:
        ...
        fig1.savefig(path_out+"fig4_rev1"+figs_format,bbox_inches='tight')
        fig1.savefig(path_out+"fig4_rev1"+figs_format2,bbox_inches='tight')
        plt.close(fig1)
